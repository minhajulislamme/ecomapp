                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ !empty($user->photo) ? url('upload/vendor_images/' . $user->photo) : url('upload/no_image.jpg') }}"
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('vendor.profile.update') }}" enctype="multipart/form-data" >
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($user->photo) ? url('upload/vendor_images/' . $user->photo) : url('upload/no_image.jpg') }}"
