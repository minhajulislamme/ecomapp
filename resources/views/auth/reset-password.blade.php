                                    ...
                                    <div class="padding_eight_all bg-white">
                                        <form method="POST" action="{{ route('password.store') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="email" id="email" required="" name="email" placeholder="Enter your email" value="{{$request->email}} "/>
                                            </div>
                                            <div class="form-group">
                                                <input type="password" required="" name="password" id="password" placeholder="Password *" />
                                            </div>
                                            <div class="form-group">
                                                <input type="password" required="" name="password_confirmation" id="password_confirmation" placeholder="Confirm you password *" />
                                            </div>
                                            <div class="form-group">
